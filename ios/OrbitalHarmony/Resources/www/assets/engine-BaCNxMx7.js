...
`)}var Dc=new Y;function Oc(e){X._getMatrix(Dc,X.workingColorSpace,e);let t=`mat3( ${Dc.elements.map(e=>e.toFixed(4))} )`;switch(X.getTransfer(e)){case Re:return[t,`LinearTransferOETF`];case ze:return[t,`sRGBTransferOETF`];default:return H(`WebGLProgram: Unsupported color space: `,e),[t,`LinearTransferOETF`]}}function kc(e,t,n){let r=e.getShaderParameter(t,e.COMPILE_STATUS),i=(e.getShaderInfoLog(t)||``).trim();if(r&&i===``)return``;let a=/ERROR: 0:(\d+)/.exec(i);if(a){let r=parseInt(a[1]);return n.toUpperCase()+`
...
void main() {
    ...
    `})}var Od=87.969,kd=10,Ad=.35;function jd(e){let t=kd*(e/Od)**+Ad;return Math.PI*2/t}function Md(e,t,n=!0){let r=new xn,i=od(e,t);r.rotation.y=i;let a=new xn;a.position.set(e.distance,0,0),r.add(a);let{tiltGroup:o,mesh:s,clouds:c,ring:l}=yd(e,{tiltAxis:`z`});a.add(o);let u=null;if(e.hasMoon&&n){u=new xn,u.rotation.y=Math.random()*Math.PI*2;let t=new di(new Ji(e.radius*.27,32,32),new sa({map:wd(id),roughness:.95}));t.position.set(e.radius*1.9,0,0),u.add(t),o.add(u)}return{data:e,pivot:r,tiltAnchor:a,axialTilt:o,mesh:s,clouds:c,moonPivot:u,startAngle:i,browseSpeed:jd(e.orbitalPeriodDays)}}function Nd(e,t,n){let r=Math.max(e,1),i=Math.log(Math.max(t,1)),a=Math.log(Math.max(n,t+1)),o=Math.log(r),s=Math.max(a-i,1e-6);return .65+1.7000000000000002*((a-o)/s)}function Pd(e){return e.orbitDirection??1}function Fd(e,t){let{planetKeys:n,interactive:r=!1,tracePattern:i=!1,physicalPattern:a=!1,connectAllPlanets:o=!1,showOrbitRings:s=!0,showMoon:c=!0,cinematicIntro:l=!1,startSettled:u=!1,orthographic:d=!1,speedDurationSec:f=10,totalSimYears:p=8,traceIntervalDays:m=3,patternOpacity:h=1,patternRates:g=null,startPaused:_=!1,initialSpeedMultiplier:v=1,miniBodiesIntro:y=!1,miniSunScale:b=.5,miniPlanetScale:x=.58,miniIntroDurationSec:S=1.15,miniMotionRampSec:C=2.6,initialSunScale:w=1,initialPlanetScale:T=1,patternStartDate:E=void 0,cosmicSnapshotDate:D=void 0}=t,O=new kn;O.background=null;let k=e.parentElement,A=k?.clientWidth||window.innerWidth,j=k?.clientHeight||window.innerHeight,ee=(n||[]).filter(e=>nd[e]),M=i&&!o&&ee.length===2,N=d?new qa(-46*A/j,46*A/j,46,-46,.1,4e3):new Wa(45,A/j,.1,2e3),P=new Wl({canvas:e,antialias:!0,powerPreference:`high-performance`});P.setPixelRatio(Math.min(window.devicePixelRatio||1,2)),P.setSize(A,j,!1),P.outputColorSpace=Ie,P.autoClear=!1,P.setClearColor(0,1),O.add(new Xa(16777215,.62));let F=new Ka(16773848,4.8,0,.1);O.add(F);let te=new Ma(16775146,2764613,.28);O.add(te);let ne=4.2,re=.75,ie={mercury:1.2,venus:1.2,earth:1.2,mars:1.2,jupiter:1,saturn:1,uranus:1.2,neptune:1.2},ae=new Ji(ne,64,64),oe=Dd(),se=new di(ae,oe);d&&se.scale.setScalar(re),O.add(se);let I=[],ce=Td();[{scale:2.5,color:16773839,opacity:.56},{scale:3.7,color:16757575,opacity:.32},{scale:5.1,color:16742973,opacity:.18}].forEach(({scale:e,color:t,opacity:n})=>{let r=new Ur(new kr({map:ce,color:t,transparent:!0,opacity:n,blending:2,depthWrite:!1})),i=ne*e*(d?re:1);r.scale.set(i,i,1),r.userData.baseScale=i,I.push(r),O.add(r)});let le=n.map(e=>nd[e]).filter(Boolean);if(M&&le.length===2){let e=Math.max(...le.map(e=>e.realDistanceAU));le=le.map(t=>({...t,distance:t.realDistanceAU/e*50}))}else le=le.map(e=>({...e}));let L=le.map(e=>{let t=Md(e,E,c);if(d){let n=ie[e.key]??1;t.axialTilt.scale.setScalar(1*n)}return O.add(t.pivot),s&&O.add(Ed(e.distance,e.color)),t}),ue=i&&_,de=y&&L.length>0||ue,fe=0,pe=!de&&!ue,me=0,he=!1;function ge(e){let t=Ct.clamp(e,0,1),n=Ct.lerp(w,b,t),r=Ct.lerp(T,x,t);se.scale.setScalar(n),I.forEach(e=>{let t=e.userData.baseScale;e.scale.set(t*n,t*n,1)}),L.forEach(e=>{e.axialTilt.scale.setScalar(r)})}de&&ge(0);let _e=Math.max(...L.map(e=>e.data.distance),20),ve=D instanceof Date&&!Number.isNaN(D.getTime()),ye=ve?L.map(e=>od(e.data,D)):null,be=L.map(e=>e.startAngle),xe=Math.min(...L.map(e=>e.data.orbitalPeriodDays)),Se=Math.max(...L.map(e=>e.data.orbitalPeriodDays)),Ce=ve?be.map((e,t)=>{let n=ye[t];return(Pd(L[t].data)<0?((n-e)%Cd+Cd)%Cd:((e-n)%Cd+Cd)%Cd)+Nd(L[t].data.orbitalPeriodDays,xe,Se)*Cd}):null,we=0,Te=!ve,Ee=0,De=0,Oe=0,ke=0,Ae=!ve,R=!ve,je=!ve,Me=!ve,Ne=[],z=[],Pe=0;if(ve&&L.length>=2){let e=[`mercury`,`venus`,`earth`,`mars`,`jupiter`,`saturn`,`uranus`,`neptune`],t=new Map(L.map(e=>[e.data.key,e])),n=e.map(e=>t.get(e)).filter(Boolean);if(n.length>=2){let e=[new J(0,0,0)];n.forEach(t=>{let n=L.indexOf(t),r=ye?.[n]??t.startAngle;e.push(new J(t.data.distance*Math.cos(r),0,-t.data.distance*Math.sin(r)))});let t=[...e,e[0].clone()];Pe=t.length;let r=e=>{let n=new Cr().setFromPoints(t);n.setDrawRange(0,2);let r=new ji(n,new Ci({color:16777215,transparent:!0,opacity:e}));return r.visible=!1,r};Ne=[r(.24),r(.85)],Ne.forEach(e=>O.add(e));let i=e=>{let n=n=>{let r=new Cr().setFromPoints(t);r.setDrawRange(0,2);let i=new ji(r,new Ci({color:16777215,transparent:!0,opacity:0}));return i.rotation.y=e,i.visible=!1,i.userData.baseOpacity=n,i};return[n(.13),n(.38)]};for(let e=0;e<36;e++)i(e/36*Cd).forEach(e=>{z.push(e),O.add(e)})}}let B=M?1.2:L.length<=2?1.4:.5;function V(e,t,n){return e*t/Math.min(1,n)}let Fe=_e,Le=B,Re=null;if(N.isOrthographicCamera){let e=V(Fe,Le,A/j);N.left=-e*A/j,N.right=e*A/j,N.top=e,N.bottom=-e,N.updateProjectionMatrix(),Re=e}let ze=su(),Be=new kn;Be.add(ze);let Ve=new Wa(85,A/j,1,4e3);function He(e,t=_e,n=B){if(N.isOrthographicCamera)return Math.max(t*n*3,200);let r=Ct.degToRad(N.fov);return t*n/(Math.tan(r/2)*Math.min(1,e))}let Ue=He(A/j);function We(e,t){let n=Ct.degToRad(t);return new J(0,e*Math.sin(n),e*Math.cos(n))}function Ge(e){return e<.5?4*e*e*e:1-(-2*e+2)**3/2}function Ke(e){return e*e*e*(e*(e*6-15)+10)}nd.earth?.distance??_e*.35;let qe=We(Ue,89.6),Je=We(Ue,24),Ye=V(_e,B,A/j),H=V(_e,1.35,A/j),U=new J(0,0,0),Xe=l?`hold`:`done`,Ze=0,Qe=null,$e=!1,W=null,et=null,tt=0;function nt(e){W=new yu(N,P.domElement),W.target.copy(e??new J(0,0,0)),W.enableDamping=!0,W.dampingFactor=.06,W.enableZoom=!0,W.zoomSpeed=.9,W.minZoom=1,W.maxZoom=3.5,W.enablePan=!1,W.enableDamping=!1,W.autoRotate=!1,W.update(),W.enableDamping=!0,tt=2,W.autoRotate=!l,W.autoRotateSpeed=.35,et||(et=e=>{if(!W||!W.enableZoom||!N.isOrthographicCamera)return;let t;if(e.key===`+`||e.key===`=`)t=1.12;else if(e.key===`-`||e.key===`_`)t=1/1.12;else return;N.zoom=Ct.clamp(N.zoom*t,W.minZoom,W.maxZoom),N.updateProjectionMatrix(),e.preventDefault()},window.addEventListener(`keydown`,et))}if(l)N.up.set(0,1,0),N.position.copy(qe),N.lookAt(U),N.isOrthographicCamera&&(N.left=-H*A/j,N.right=H*A/j,N.top=H,N.bottom=-H,N.updateProjectionMatrix(),Re=H);else if(u&&r){if(N.up.set(0,1,0),N.position.copy(Je),N.lookAt(U),N.isOrthographicCamera){let e=Ye;N.left=-e*A/j,N.right=e*A/j,N.top=e,N.bottom=-e,N.updateProjectionMatrix(),Re=e,Fe=_e,Le=B}N.lookAt(U),nt(U),W.autoRotate=!1}else r?(N.position.set(0,Ue,Ue*.001),nt()):(N.up.set(0,0,-1),N.position.set(0,Ue,1e-4),N.lookAt(0,0,0));let G=null,K=null,rt=null,it=null,at=0,ot=0,st=[[0,1]],ct=new J,lt=new J;if(i&&L.length>=2){st=o?L.map((e,t)=>[t,(t+1)%L.length]):[[0,1]];let e=Math.ceil(p*Sd/m);at=Math.min(e*st.length,4e4),K=new Float32Array(at*2*3);let t=new Pu;t.setPositions(K),t.instanceCount=0,rt=new Float32Array(at*2),it=new ho(rt,2,1),t.setAttribute(`instanceDistanceStart`,new Er(it,1,0)),t.setAttribute(`instanceDistanceEnd`,new Er(it,1,1));let n=new Fu({color:16777215,transparent:!0,opacity:h,linewidth:ld,depthWrite:!1,dashed:!0,dashScale:1,dashSize:bd.solid.dashSize,gapSize:bd.solid.gapSize});n.resolution.set(A,j),G=new ed(t,n),G.frustumCulled=!1,O.add(G)}let ut=new go,dt=0,ft=0,pt=0,mt=i?p*Sd/f:6,ht=v,gt=_,_t=!1,vt=null,yt=null,bt=`solid`;function xt(e,t){let n=(g?g[e.data.key]:void 0)??(a?365.256/e.data.orbitalPeriodDays:e.data.traceSpeed??365.256/e.data.orbitalPeriodDays);return e.startAngle+Pd(e.data)*(t/Sd)*n*Cd}function St(e,t,n){let r=xt(e,t);return n.set(e.data.distance*Math.cos(r),0,-e.data.distance*Math.sin(r))}function q(){if(!G||ot>=at)return;let e=!1,t=st.length;for(;dt-pt>=m&&ot+t<=at;){pt+=m;for(let e=0;e<t;e++){let t=st[e];St(L[t[0]],pt,ct),St(L[t[1]],pt,lt);let n=ot*6;K[n]=ct.x,K[n+1]=ct.y,K[n+2]=ct.z,K[n+3]=lt.x,K[n+4]=lt.y,K[n+5]=lt.z;let r=ot*2;rt[r]=0,rt[r+1]=ct.distanceTo(lt),ot++}e=!0}e&&(G.geometry.attributes.instanceStart.data.needsUpdate=!0,G.geometry.instanceCount=ot,it.needsUpdate=!0)}function wt(){P.clear(),Ve.quaternion.copy(N.quaternion),P.render(Be,Ve),P.clearDepth(),P.render(O,N)}function Tt(){yt=requestAnimationFrame(Tt);let e=Math.min(ut.getDelta(),.05);if(ue&&!he&&!gt&&(he=!0,fe=0),!pe){fe+=e;let t=0;if(ue&&he){let e=Math.max(0,fe-.3);t=Math.min(e/Math.max(.01,S),1)}else y&&!ue&&(t=Math.min(fe/Math.max(.01,S),1));ge(Ke(t)),t>=1&&(pe=!0)}de&&pe&&(me=Math.min(me+e,Math.max(.01,C)));let t=de?pe?Ct.clamp(me/Math.max(.01,C),0,1):0:1;if(gt){wt();return}if(se.rotation.y+=e*.03,oe.uniforms.time.value+=e,ze.children.forEach(t=>{t.rotation.y+=e*t.userData.spin,t.material.uniforms?.uTime&&(t.material.uniforms.uTime.value+=e)}),_t||(dt+=e*mt*ht*t),_t||(ft+=e*t),ve&&!Te)we+=e,L.forEach((e,t)=>{let n=be[t];e.pivot.rotation.y=n,e.tiltAnchor.rotation.y=-n}),we>=2.2&&(Te=!0);else if(ve&&!Ae){Ee+=e;let t=Math.min(Ee/7.2,1),n=Ge(t);L.forEach((e,t)=>{let r=Pd(e.data)<0?be[t]+Ce[t]*n:be[t]-Ce[t]*n;e.pivot.rotation.y=r,e.tiltAnchor.rotation.y=-r}),t>=1&&(Ae=!0)}else ve&&!R?(L.forEach((e,t)=>{let n=ye[t];e.pivot.rotation.y=n,e.tiltAnchor.rotation.y=-n}),De+=e,De>=.7&&(R=!0)):ve?L.forEach((e,t)=>{let n=ye[t];e.pivot.rotation.y=n,e.tiltAnchor.rotation.y=-n}):(L.forEach(e=>{i?e.pivot.rotation.y=xt(e,dt):e.pivot.rotation.y=e.startAngle+ft*e.browseSpeed*Pd(e.data),e.tiltAnchor.rotation.y=-e.pivot.rotation.y}),L.forEach(n=>{n.mesh.rotation.y+=e*60*n.data.rotationSpeed*(n.data.spinDirection??1)*t,n.clouds&&(n.clouds.rotation.y+=e*60*n.data.rotationSpeed*1.4*(n.data.spinDirection??1)*t),n.moonPivot&&(n.moonPivot.rotation.y+=e*1.4)}));if(O.updateMatrixWorld(!0),i&&(!ue||pe)&&q(),ve&&Ae&&R&&Ne.length>0&&!je){Oe+=e;let t=Math.min(Oe/2.8,1),n=Ke(t),r=Math.max(2,Math.floor(2+n*(Pe-2)));Ne.forEach(e=>{e.visible=!0,e.geometry.setDrawRange(0,r)}),t>=1&&(je=!0)}if(ve&&je&&z.length>0&&!Me){ke+=e;let t=Math.min(ke/4.2,1),n=Ke(t);Ne.forEach(e=>{e.material.opacity=e.material.opacity*(1-n*.9)});for(let e=0;e<36;e++){let t=e/35,r=Ct.clamp((n-t*.5)/.5,0,1),i=Math.max(2,Math.floor(2+Ke(r)*(Pe-2)));[z[e*2],z[e*2+1]].forEach(e=>{e.visible=r>0,e.geometry.setDrawRange(0,i),e.material.opacity=e.userData.baseOpacity*r})}t>=1&&(Me=!0)}if(i&&!_t&&dt>=p*Sd&&(_t=!0,vt&&vt()),ve&&Me&&!_t&&(_t=!0,vt&&vt()),Xe!==`done`){if(Ze+=e,Xe===`hold`)Ze>=.8&&(Xe=`travel`,Ze=0);else if(Xe===`travel`){let e=Math.min(Ze/2.1,1),t=Ge(e);N.position.lerpVectors(qe,Je,t),N.lookAt(U),e>=1&&(Xe=`zoom`,Ze=0)}else if(Xe===`zoom`){let e=Math.min(Ze/2.2,1),t=Ke(e);if(N.isOrthographicCamera){let e=H*(Ye/H)**+t;N.left=-e*A/j,N.right=e*A/j,N.top=e,N.bottom=-e,N.updateProjectionMatrix(),Re=e}e>=1&&(Xe=`done`,Fe=_e,Le=B,N.lookAt(U),r&&nt(U),Qe&&($e=!0))}}W&&(tt>0?--tt:W.update()),wt(),$e&&($e=!1,Qe?.())}function Et(){let e=k?.clientWidth||window.innerWidth,t=k?.clientHeight||window.innerHeight;if(N.isOrthographicCamera){let n=Re??V(Fe,Le,e/t);N.left=-n*e/t,N.right=n*e/t,N.top=n,N.bottom=-n}else if(N.aspect=e/t,!W){let n=He(e/t);N.position.setLength(n)}N.updateProjectionMatrix(),Ve.aspect=e/t,Ve.updateProjectionMatrix(),P.setSize(e,t,!1),G&&G.material.resolution.set(e,t)}let Y=new ResizeObserver(Et);return k&&Y.observe(k),window.addEventListener(`resize`,Et),{start(){yt??Tt()},setPaused(e){gt=e},setLineStyle(e){if(bt=bd[e]?e:`solid`,!G)return;let t=bd[bt];G.material.dashSize=t.dashSize,G.material.gapSize=t.gapSize,G.material.linewidth=ld*(t.widthScale??1)},setSpeedMultiplier(e){ht=Math.max(.1,e)},reset(){dt=0,pt=0,ot=0,_t=!1,fe=0,pe=!de&&!ue,me=0,he=!1,de&&ge(0),G&&(G.geometry.instanceCount=0),L.forEach(e=>{e.pivot.rotation.y=e.startAngle,e.tiltAnchor.rotation.y=-e.startAngle}),O.updateMatrixWorld(!0),wt()},getProgress(){return i?Math.min(dt/(p*Sd),1):0},onComplete(e){vt=e},onIntroComplete(e){Qe=e,Xe===`done`&&e()},captureDataURL(){let e=Math.max(P.getPixelRatio(),2);P.setPixelRatio(e),P.setSize(A,j,!1);let t=se.visible;se.visible=!1,I.forEach(e=>{e.visible=!1}),L.forEach(e=>{e.pivot.visible=!1});let n=G?G.visible:!1;G&&(G.visible=!1),wt(),G&&(G.visible=n);let r=P.domElement.width,i=P.domElement.height,a=document.createElement(`canvas`);a.width=r,a.height=i;let o=a.getContext(`2d`);if(o.drawImage(P.domElement,0,0),G&&ot>0){o.strokeStyle=`rgba(255,255,255,${h})`,o.lineJoin=`round`;let t=xd[bt],n=bd[bt];o.lineWidth=ld*e*(t?.widthScale??1),o.lineCap=t?.cap??`round`;let a=new J;for(let s=0;s<ot;s++){let c=s*6;a.set(K[c],K[c+1],K[c+2]).project(N);let l=(a.x*.5+.5)*r,u=(1-(a.y*.5+.5))*i;a.set(K[c+3],K[c+4],K[c+5]).project(N);let d=(a.x*.5+.5)*r,f=(1-(a.y*.5+.5))*i;if(t&&bt!==`solid`){let r=rt[s*2+1]||1,i=(Math.hypot(d-l,f-u)||1)/r,a=t.fixedDashPx==null?n.dashSize*i:t.fixedDashPx*e;o.setLineDash([a,n.gapSize*i])}else o.setLineDash([]);o.beginPath(),o.moveTo(l,u),o.lineTo(d,f),o.stroke()}}let s=a.toDataURL(`image/png`);return se.visible=t,I.forEach(e=>{e.visible=!0}),L.forEach(e=>{e.pivot.visible=!0}),P.setPixelRatio(Math.min(window.devicePixelRatio||1,2)),P.setSize(A,j,!1),wt(),s},destroy(){yt!=null&&cancelAnimationFrame(yt),window.removeEventListener(`resize`,Et),et&&window.removeEventListener(`keydown`,et),Y.disconnect(),W&&W.dispose(),P.dispose(),O.traverse(e=>{e.geometry&&e.geometry.dispose(),e.material&&(Array.isArray(e.material)?e.material:[e.material]).forEach(e=>e.dispose())})}}}function Id(e){let t=new xn,{tiltGroup:n,mesh:r,material:i,ring:a}=yd(e,{radius:1,tiltAxis:`x`});n.rotation.set(0,0,0);let o=new xn;return o.add(n),t.add(o),i.transparent=!0,a&&(a.material.transparent=!0,a.rotation.x=-Math.PI/2,n.rotation.x=Ct.degToRad(15),n.rotation.y=Ct.degToRad(30),o.rotation.z=Ct.degToRad(30),a.userData.presentationScale=.94),{group:t,mesh:r,material:i,ring:a,spinSpeed:.02*(e.spinDirection??1)*15}}function Ld(e,t){let n=new Wl({canvas:e,alpha:!0,antialias:!0});n.setClearColor(0,0),n.outputColorSpace=Ie;let r=new kn,i=new qa(-1,1,1,-1,-2e3,2e3);i.position.z=400,r.add(new Xa(16777215,.58));let a=new Ya(16773855,2.1);a.position.set(-140,90,260),r.add(a);let o=new Map;t.forEach(e=>{let t=Id(e);r.add(t.group),o.set(e.key,t)});let s=null,c=new go;function l(e){o.forEach((t,n)=>{e[n]!=null&&(t.group.position.x=e[n])})}function u(e,t,r,a){n.setPixelRatio(Math.min(a||1,2)),n.setSize(t,r,!1),i.left=-t/2,i.right=t/2,i.top=r/2,i.bottom=-r/2,i.position.x=e+t/2,i.updateProjectionMatrix()}function d(e,{radiusPx:t,scale:n,opacity:r,dim:i,disabled:a}){let s=o.get(e);if(!s)return;let c=t*n;s.mesh.scale.setScalar(c),s.material.opacity=a?Math.min(r,.35):r,s.material.color.setScalar(a?.4:i),s.ring&&(s.ring.scale.setScalar(c*(s.ring.userData.presentationScale??1)),s.ring.material.opacity=a?Math.min(r,.35):r,s.ring.material.color.setScalar(a?.4:i))}function f(){s=requestAnimationFrame(f);let e=Math.min(c.getDelta(),.05);o.forEach(t=>{t.mesh.rotation.y+=e*t.spinSpeed}),n.render(r,i)}return{setLayout:l,setViewport:u,setPlanetState:d,start(){s??f()},destroy(){s!=null&&cancelAnimationFrame(s),r.traverse(e=>{e.geometry&&e.geometry.dispose(),e.material&&(Array.isArray(e.material)?e.material:[e.material]).forEach(e=>e.dispose())}),n.dispose()}}}export{sd as a,cu as c,fd as i,Fd as n,td as o,_d as r,nd as s,Ld as t};