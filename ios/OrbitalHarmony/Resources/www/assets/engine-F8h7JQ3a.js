...
void main() {
    ...
    `})}var Dd=87.969,Od=10,kd=.35;function Ad(e){let t=Od*(e/Dd)**+kd;return Math.PI*2/t}function jd(e,t){let n=new xn,r=od(e,t);n.rotation.y=r;let i=new xn;i.position.set(e.distance,0,0),n.add(i);let{tiltGroup:a,mesh:o,clouds:s,ring:c}=yd(e,{tiltAxis:`z`});i.add(a);let l=null;if(e.hasMoon){l=new xn,l.rotation.y=Math.random()*Math.PI*2;let t=new di(new Ji(e.radius*.27,32,32),new sa({map:Cd(id),roughness:.95}));t.position.set(e.radius*1.9,0,0),l.add(t),a.add(l)}return{data:e,pivot:n,tiltAnchor:i,axialTilt:a,mesh:o,clouds:s,moonPivot:l,startAngle:r,browseSpeed:Ad(e.orbitalPeriodDays)}}function Md(e,t,n){let r=Math.max(e,1),i=Math.log(Math.max(t,1)),a=Math.log(Math.max(n,t+1)),o=Math.log(r),s=Math.max(a-i,1e-6);return .65+1.7000000000000002*((a-o)/s)}function Nd(e){return e.orbitDirection??1}function Pd(e,t){let{planetKeys:n,interactive:r=!1,tracePattern:i=!1,physicalPattern:a=!1,connectAllPlanets:o=!1,showOrbitRings:s=!0,cinematicIntro:c=!1,startSettled:l=!1,orthographic:u=!1,speedDurationSec:d=10,totalSimYears:f=8,traceIntervalDays:p=3,patternOpacity:m=1,patternRates:h=null,startPaused:g=!1,initialSpeedMultiplier:_=1,miniBodiesIntro:v=!1,miniSunScale:y=.5,miniPlanetScale:b=.58,miniIntroDurationSec:x=1.15,miniMotionRampSec:S=2.6,patternStartDate:C=void 0,cosmicSnapshotDate:w=void 0}=t,T=new kn;T.background=null;let E=e.parentElement,D=E?.clientWidth||window.innerWidth,O=E?.clientHeight||window.innerHeight,k=(n||[]).filter(e=>nd[e]),A=i&&!o&&k.length===2,j=u?new qa(-46*D/O,46*D/O,46,-46,.1,4e3):new Wa(45,D/O,.1,2e3),ee=new Wl({canvas:e,antialias:!0,powerPreference:`high-performance`});ee.setPixelRatio(Math.min(window.devicePixelRatio||1,2)),ee.setSize(D,O,!1),ee.outputColorSpace=Ie,ee.autoClear=!1,ee.setClearColor(0,1),T.add(new Xa(16777215,.62));let M=new Ka(16773848,4.8,0,.1);T.add(M);let te=new Ma(16775146,2764613,.28);T.add(te);let N=4.2,P=.75,ne={mercury:1.2,venus:1.2,earth:1.2,mars:1.2,jupiter:1,saturn:1,uranus:1.2,neptune:1.2},re=new Ji(N,64,64),ie=Ed(),ae=new di(re,ie);u&&ae.scale.setScalar(P),T.add(ae);let oe=[],se=wd();[{scale:2.5,color:16773839,opacity:.56},{scale:3.7,color:16757575,opacity:.32},{scale:5.1,color:16742973,opacity:.18}].forEach(({scale:e,color:t,opacity:n})=>{let r=new Ur(new kr({map:se,color:t,transparent:!0,opacity:n,blending:2,depthWrite:!1})),i=N*e*(u?P:1);r.scale.set(i,i,1),r.userData.baseScale=i,oe.push(r),T.add(r)});let ce=n.map(e=>nd[e]).filter(Boolean);if(A&&ce.length===2){let e=Math.max(...ce.map(e=>e.realDistanceAU));ce=ce.map(t=>({...t,distance:t.realDistanceAU/e*50}))}else ce=ce.map(e=>({...e}));let F=ce.map(e=>{let t=jd(e,C);if(u){let n=ne[e.key]??1;t.axialTilt.scale.setScalar(1*n)}return T.add(t.pivot),s&&T.add(Td(e.distance,e.color)),t}),le=i&&g,ue=v&&F.length>0||le,de=0,fe=!ue&&!le,pe=0,me=!1;function he(e){let t=Ct.clamp(e,0,1),n=Ct.lerp(1,y,t),r=Ct.lerp(1,b,t);ae.scale.setScalar(n),oe.forEach(e=>{let t=e.userData.baseScale;e.scale.set(t*n,t*n,1)}),F.forEach(e=>{e.axialTilt.scale.setScalar(r)})}ue&&he(0);let ge=Math.max(...F.map(e=>e.data.distance),20),I=w instanceof Date&&!Number.isNaN(w.getTime()),_e=I?F.map(e=>od(e.data,w)):null,ve=F.map(e=>e.startAngle),ye=Math.min(...F.map(e=>e.data.orbitalPeriodDays)),be=Math.max(...F.map(e=>e.data.orbitalPeriodDays)),xe=I?ve.map((e,t)=>{let n=_e[t];return(Nd(F[t].data)<0?((n-e)%Sd+Sd)%Sd:((e-n)%Sd+Sd)%Sd)+Md(F[t].data.orbitalPeriodDays,ye,be)*Sd}):null,Se=0,Ce=!I,we=0,Te=0,Ee=0,De=0,Oe=!I,ke=!I,Ae=!I,je=!I,L=[],Me=[],R=0;if(I&&F.length>=2){let e=[`mercury`,`venus`,`earth`,`mars`,`jupiter`,`saturn`,`uranus`,`neptune`],t=new Map(F.map(e=>[e.data.key,e])),n=e.map(e=>t.get(e)).filter(Boolean);if(n.length>=2){let e=[new J(0,0,0)];n.forEach(t=>{let n=F.indexOf(t),r=_e?.[n]??t.startAngle;e.push(new J(t.data.distance*Math.cos(r),0,-t.data.distance*Math.sin(r)))});let t=[...e,e[0].clone()];R=t.length;let r=e=>{let n=new Cr().setFromPoints(t);n.setDrawRange(0,2);let r=new ji(n,new Ci({color:16777215,transparent:!0,opacity:e}));return r.visible=!1,r};L=[r(.18),r(.66)],L.forEach(e=>T.add(e));let i=e=>{let n=n=>{let r=new Cr().setFromPoints(t);r.setDrawRange(0,2);let i=new ji(r,new Ci({color:16777215,transparent:!0,opacity:0}));return i.rotation.y=e,i.visible=!1,i.userData.baseOpacity=n,i};return[n(.08),n(.24)]};for(let e=0;e<36;e++)i(e/36*Sd).forEach(e=>{Me.push(e),T.add(e)})}}let Ne=A?1.2:F.length<=2?1.4:.5;function z(e,t,n){return e*t/Math.min(1,n)}let Pe=ge,B=Ne,V=null;if(j.isOrthographicCamera){let e=z(Pe,B,D/O);j.left=-e*D/O,j.right=e*D/O,j.top=e,j.bottom=-e,j.updateProjectionMatrix(),V=e}let Fe=su(),Le=new kn;Le.add(Fe);let Re=new Wa(85,D/O,1,4e3);function ze(e,t=ge,n=Ne){if(j.isOrthographicCamera)return Math.max(t*n*3,200);let r=Ct.degToRad(j.fov);return t*n/(Math.tan(r/2)*Math.min(1,e))}let Be=ze(D/O);function Ve(e,t){let n=Ct.degToRad(t);return new J(0,e*Math.sin(n),e*Math.cos(n))}function He(e){return e<.5?4*e*e*e:1-(-2*e+2)**3/2}function Ue(e){return e*e*e*(e*(e*6-15)+10)}nd.earth?.distance??ge*.35;let We=Ve(Be,89.6),Ge=Ve(Be,24),Ke=z(ge,Ne,D/O),qe=z(ge,1.35,D/O),Je=new J(0,0,0),Ye=c?`hold`:`done`,H=0,U=null,Xe=!1,Ze=null,Qe=null,$e=0;function et(e){Ze=new yu(j,ee.domElement),Ze.target.copy(e??new J(0,0,0)),Ze.enableDamping=!0,Ze.dampingFactor=.06,Ze.enableZoom=!0,Ze.zoomSpeed=.9,Ze.minZoom=1,Ze.maxZoom=3.5,Ze.enablePan=!1,Ze.enableDamping=!1,Ze.autoRotate=!1,Ze.update(),Ze.enableDamping=!0,$e=2,Ze.autoRotate=!c,Ze.autoRotateSpeed=.35,Qe||(Qe=e=>{if(!Ze||!Ze.enableZoom||!j.isOrthographicCamera)return;let t;if(e.key===`+`||e.key===`=`)t=1.12;else if(e.key===`-`||e.key===`_`)t=1/1.12;else return;j.zoom=Ct.clamp(j.zoom*t,Ze.minZoom,Ze.maxZoom),j.updateProjectionMatrix(),e.preventDefault()},window.addEventListener(`keydown`,Qe))}if(c)j.up.set(0,1,0),j.position.copy(We),j.lookAt(Je),j.isOrthographicCamera&&(j.left=-qe*D/O,j.right=qe*D/O,j.top=qe,j.bottom=-qe,j.updateProjectionMatrix(),V=qe);else if(l&&r){if(j.up.set(0,1,0),j.position.copy(Ge),j.lookAt(Je),j.isOrthographicCamera){let e=Ke;j.left=-e*D/O,j.right=e*D/O,j.top=e,j.bottom=-e,j.updateProjectionMatrix(),V=e,Pe=ge,B=Ne}j.lookAt(Je),et(Je),Ze.autoRotate=!1}else r?(j.position.set(0,Be,Be*.001),et()):(j.up.set(0,0,-1),j.position.set(0,Be,1e-4),j.lookAt(0,0,0));let tt=null,nt=null,rt=null,W=null,G=0,it=0,at=[[0,1]],ot=new J,st=new J;if(i&&F.length>=2){at=o?F.map((e,t)=>[t,(t+1)%F.length]):[[0,1]];let e=Math.ceil(f*xd/p);G=Math.min(e*at.length,4e4),nt=new Float32Array(G*2*3);let t=new Pu;t.setPositions(nt),t.instanceCount=0,rt=new Float32Array(G*2),W=new ho(rt,2,1),t.setAttribute(`instanceDistanceStart`,new Er(W,1,0)),t.setAttribute(`instanceDistanceEnd`,new Er(W,1,1));let n=new Fu({color:16777215,transparent:!0,opacity:m,linewidth:ld,depthWrite:!1,dashed:!0,dashScale:1,dashSize:bd.solid.dashSize,gapSize:bd.solid.gapSize});n.resolution.set(D,O),tt=new ed(t,n),tt.frustumCulled=!1,T.add(tt)}let ct=new go,lt=0,ut=0,dt=0,ft=i?f*xd/d:6,pt=_,mt=g,ht=!1,gt=null,_t=null;function vt(e,t){let n=(h?h[e.data.key]:void 0)??(a?365.256/e.data.orbitalPeriodDays:e.data.traceSpeed??365.256/e.data.orbitalPeriodDays);return e.startAngle+Nd(e.data)*(t/xd)*n*Sd}function yt(e,t,n){let r=vt(e,t);return n.set(e.data.distance*Math.cos(r),0,-e.data.distance*Math.sin(r))}function bt(){if(!tt||it>=G)return;let e=!1,t=at.length;for(;lt-dt>=p&&it+t<=G;){dt+=p;for(let e=0;e<t;e++){let t=at[e];yt(F[t[0]],dt,ot),yt(F[t[1]],dt,st);let n=it*6;nt[n]=ot.x,nt[n+1]=ot.y,nt[n+2]=ot.z,nt[n+3]=st.x,nt[n+4]=st.y,nt[n+5]=st.z;let r=it*2;rt[r]=0,rt[r+1]=ot.distanceTo(st),it++}e=!0}e&&(tt.geometry.attributes.instanceStart.data.needsUpdate=!0,tt.geometry.instanceCount=it,W.needsUpdate=!0)}function xt(){ee.clear(),Re.quaternion.copy(j.quaternion),ee.render(Le,Re),ee.clearDepth(),ee.render(T,j)}function St(){_t=requestAnimationFrame(St);let e=Math.min(ct.getDelta(),.05);if(le&&!me&&!mt&&(me=!0,de=0),!fe){de+=e;let t=0;if(le&&me){let e=Math.max(0,de-.3);t=Math.min(e/Math.max(.01,x),1)}else v&&!le&&(t=Math.min(de/Math.max(.01,x),1));he(Ue(t)),t>=1&&(fe=!0)}ue&&fe&&(pe=Math.min(pe+e,Math.max(.01,S)));let t=ue?fe?Ct.clamp(pe/Math.max(.01,S),0,1):0:1;if(mt){xt();return}if(ae.rotation.y+=e*.03,ie.uniforms.time.value+=e,Fe.children.forEach(t=>{t.rotation.y+=e*t.userData.spin,t.material.uniforms?.uTime&&(t.material.uniforms.uTime.value+=e)}),ht||(lt+=e*ft*pt*t),ht||(ut+=e*t),I&&!Ce)Se+=e,F.forEach((e,t)=>{let n=ve[t];e.pivot.rotation.y=n,e.tiltAnchor.rotation.y=-n}),Se>=2.2&&(Ce=!0);else if(I&&!Oe){we+=e;let t=Math.min(we/7.2,1),n=He(t);F.forEach((e,t)=>{let r=Nd(e.data)<0?ve[t]+xe[t]*n:ve[t]-xe[t]*n;e.pivot.rotation.y=r,e.tiltAnchor.rotation.y=-r}),t>=1&&(Oe=!0)}else I&&!ke?(F.forEach((e,t)=>{let n=_e[t];e.pivot.rotation.y=n,e.tiltAnchor.rotation.y=-n}),Te+=e,Te>=.7&&(ke=!0)):I?F.forEach((e,t)=>{let n=_e[t];e.pivot.rotation.y=n,e.tiltAnchor.rotation.y=-n}):(F.forEach(e=>{i?e.pivot.rotation.y=vt(e,lt):e.pivot.rotation.y=e.startAngle+ut*e.browseSpeed*Nd(e.data),e.tiltAnchor.rotation.y=-e.pivot.rotation.y}),F.forEach(n=>{n.mesh.rotation.y+=e*60*n.data.rotationSpeed*(n.data.spinDirection??1)*t,n.clouds&&(n.clouds.rotation.y+=e*60*n.data.rotationSpeed*1.4*(n.data.spinDirection??1)*t),n.moonPivot&&(n.moonPivot.rotation.y+=e*1.4)}));if(T.updateMatrixWorld(!0),i&&(!le||fe)&&bt(),I&&Oe&&ke&&L.length>0&&!Ae){Ee+=e;let t=Math.min(Ee/2.8,1),n=Ue(t),r=Math.max(2,Math.floor(2+n*(R-2)));L.forEach(e=>{e.visible=!0,e.geometry.setDrawRange(0,r)}),t>=1&&(Ae=!0)}if(I&&Ae&&Me.length>0&&!je){De+=e;let t=Math.min(De/4.2,1),n=Ue(t);L.forEach(e=>{e.material.opacity=e.material.opacity*(1-n*.9)});for(let e=0;e<36;e++){let t=e/35,r=Ct.clamp((n-t*.5)/.5,0,1),i=Math.max(2,Math.floor(2+Ue(r)*(R-2)));[Me[e*2],Me[e*2+1]].forEach(e=>{e.visible=r>0,e.geometry.setDrawRange(0,i),e.material.opacity=e.userData.baseOpacity*r})}t>=1&&(je=!0)}if(i&&!ht&&lt>=f*xd&&(ht=!0,gt&&gt()),I&&je&&!ht&&(ht=!0,gt&&gt()),Ye!==`done`){if(H+=e,Ye===`hold`)H>=.8&&(Ye=`travel`,H=0);else if(Ye===`travel`){let e=Math.min(H/2.1,1),t=He(e);j.position.lerpVectors(We,Ge,t),j.lookAt(Je),e>=1&&(Ye=`zoom`,H=0)}else if(Ye===`zoom`){let e=Math.min(H/2.2,1),t=Ue(e);if(j.isOrthographicCamera){let e=qe*(Ke/qe)**+t;j.left=-e*D/O,j.right=e*D/O,j.top=e,j.bottom=-e,j.updateProjectionMatrix(),V=e}e>=1&&(Ye=`done`,Pe=ge,B=Ne,j.lookAt(Je),r&&et(Je),U&&(Xe=!0))}}Ze&&($e>0?--$e:Ze.update()),xt(),Xe&&(Xe=!1,U?.())}function K(){let e=E?.clientWidth||window.innerWidth,t=E?.clientHeight||window.innerHeight;if(j.isOrthographicCamera){let n=V??z(Pe,B,e/t);j.left=-n*e/t,j.right=n*e/t,j.top=n,j.bottom=-n}else if(j.aspect=e/t,!Ze){let n=ze(e/t);j.position.setLength(n)}j.updateProjectionMatrix(),Re.aspect=e/t,Re.updateProjectionMatrix(),ee.setSize(e,t,!1),tt&&tt.material.resolution.set(e,t)}let q=new ResizeObserver(K);return E&&q.observe(E),window.addEventListener(`resize`,K),{start(){_t??St()},setPaused(e){mt=e},setLineStyle(e){if(!tt)return;let t=bd[e]??bd.solid;tt.material.dashSize=t.dashSize,tt.material.gapSize=t.gapSize},setSpeedMultiplier(e){pt=Math.max(.1,e)},reset(){lt=0,dt=0,it=0,ht=!1,de=0,fe=!ue&&!le,pe=0,me=!1,ue&&he(0),tt&&(tt.geometry.instanceCount=0),F.forEach(e=>{e.pivot.rotation.y=e.startAngle,e.tiltAnchor.rotation.y=-e.startAngle}),T.updateMatrixWorld(!0),xt()},getProgress(){return i?Math.min(lt/(f*xd),1):0},onComplete(e){gt=e},onIntroComplete(e){U=e,Ye===`done`&&e()},captureDataURL(){ae.visible=!1,oe.forEach(e=>{e.visible=!1}),F.forEach(e=>{e.pivot.visible=!1}),xt();let e=ee.domElement.toDataURL(`image/png`);return ae.visible=!0,oe.forEach(e=>{e.visible=!0}),F.forEach(e=>{e.pivot.visible=!0}),xt(),e},destroy(){_t!=null&&cancelAnimationFrame(_t),window.removeEventListener(`resize`,K),Qe&&window.removeEventListener(`keydown`,Qe),q.disconnect(),Ze&&Ze.dispose(),ee.dispose(),T.traverse(e=>{e.geometry&&e.geometry.dispose(),e.material&&(Array.isArray(e.material)?e.material:[e.material]).forEach(e=>e.dispose())})}}}function Fd(e){let t=new xn,{tiltGroup:n,mesh:r,material:i,ring:a}=yd(e,{radius:1,tiltAxis:`x`});n.rotation.set(0,0,0);let o=new xn;return o.add(n),t.add(o),i.transparent=!0,a&&(a.material.transparent=!0,a.rotation.x=-Math.PI/2,n.rotation.x=Ct.degToRad(15),n.rotation.y=Ct.degToRad(30),o.rotation.z=Ct.degToRad(30),a.userData.presentationScale=.94),{group:t,mesh:r,material:i,ring:a,spinSpeed:(e.rotationSpeed??.02)*(e.spinDirection??1)*15}}function Id(e,t){let n=new Wl({canvas:e,alpha:!0,antialias:!0});n.setClearColor(0,0),n.outputColorSpace=Ie;let r=new kn,i=new qa(-1,1,1,-1,-2e3,2e3);i.position.z=400,r.add(new Xa(16777215,.58));let a=new Ya(16773855,2.1);a.position.set(-140,90,260),r.add(a);let o=new Map;t.forEach(e=>{let t=Fd(e);r.add(t.group),o.set(e.key,t)});let s=null,c=new go;function l(e){o.forEach((t,n)=>{e[n]!=null&&(t.group.position.x=e[n])})}function u(e,t,r,a){n.setPixelRatio(Math.min(a||1,2)),n.setSize(t,r,!1),i.left=-t/2,i.right=t/2,i.top=r/2,i.bottom=-r/2,i.position.x=e+t/2,i.updateProjectionMatrix()}function d(e,{radiusPx:t,scale:n,opacity:r,dim:i,disabled:a}){let s=o.get(e);if(!s)return;let c=t*n;s.mesh.scale.setScalar(c),s.material.opacity=a?Math.min(r,.35):r,s.material.color.setScalar(a?.4:i),s.ring&&(s.ring.scale.setScalar(c*(s.ring.userData.presentationScale??1)),s.ring.material.opacity=a?Math.min(r,.35):r,s.ring.material.color.setScalar(a?.4:i))}function f(){s=requestAnimationFrame(f);let e=Math.min(c.getDelta(),.05);o.forEach(t=>{t.mesh.rotation.y+=e*t.spinSpeed}),n.render(r,i)}return{setLayout:l,setViewport:u,setPlanetState:d,start(){s??f()},destroy(){s!=null&&cancelAnimationFrame(s),r.traverse(e=>{e.geometry&&e.geometry.dispose(),e.material&&(Array.isArray(e.material)?e.material:[e.material]).forEach(e=>e.dispose())}),n.dispose()}}}export{sd as a,cu as c,fd as i,Pd as n,td as o,_d as r,nd as s,Id as t};