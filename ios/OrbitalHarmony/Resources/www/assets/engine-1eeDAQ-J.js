...
void main() {
    ...
    `})}var xp=87.969,Sp=10,Cp=.35;function wp(e){let t=Sp*(e/xp)**+Cp;return Math.PI*2/t}function Tp(e,t,n=!0){let r=new xn,i=Xf(e,t);r.rotation.y=i;let a=new xn;a.position.set(e.distance,0,0),r.add(a);let{tiltGroup:o,mesh:s,clouds:c}=fp(e,{tiltAxis:`z`});a.add(o);let l=null;if(e.hasMoon&&n){l=new xn,l.rotation.y=Math.random()*Math.PI*2;let t=new di(new Ji(e.radius*.27,32,32),new sa({map:_p(od),roughness:.95}));t.position.set(e.radius*1.9,0,0),l.add(t),o.add(l)}return{data:e,pivot:r,tiltAnchor:a,axialTilt:o,mesh:s,clouds:c,moonPivot:l,startAngle:i,browseSpeed:wp(e.orbitalPeriodDays)}}function Ep(e,t,n){let r=Math.max(e,1),i=Math.log(Math.max(t,1)),a=Math.log(Math.max(n,t+1)),o=Math.log(r),s=Math.max(a-i,1e-6),c=(a-o)/s;return Math.round(.65+1.7000000000000002*c)}function Dp(e){return e.orbitDirection??1}function Op(e,t){let{planetKeys:n,interactive:r=!1,tracePattern:i=!1,physicalPattern:a=!1,connectAllPlanets:o=!1,showOrbitRings:s=!0,showMoon:c=!0,cinematicIntro:l=!1,startSettled:u=!1,orthographic:d=!1,speedDurationSec:f=10,totalSimYears:p=8,traceIntervalDays:m=3,patternOpacity:h=1,patternRates:g=null,startPaused:_=!1,initialSpeedMultiplier:v=1,miniBodiesIntro:y=!1,miniSunScale:b=.5,miniPlanetScale:x=.58,miniIntroDurationSec:S=1.15,miniMotionRampSec:C=2.6,initialSunScale:w=1,initialPlanetScale:T=1,patternStartDate:E=void 0,cosmicSnapshotDate:D=void 0,compositionOffsetY:O=0}=t,k=new kn;k.background=null;let A=e.parentElement,j=A?.clientWidth||window.innerWidth,M=A?.clientHeight||window.innerHeight,N=(n||[]).filter(e=>id[e]),ee=i&&!o&&N.length===2,P=d?new qa(-46*j/M,46*j/M,46,-46,.1,4e3):new Wa(45,j/M,.1,2e3),F=Kl(e,{antialias:!0,powerPreference:`high-performance`});F.setPixelRatio(Math.min(window.devicePixelRatio||1,2)),F.setSize(j,M,!1),F.outputColorSpace=Fe,F.autoClear=!1,F.setClearColor(0,1),k.add(new Xa(16777215,.62));let te=new Ka(16773848,4.8,0,.1);k.add(te);let ne=new Ma(16775146,2764613,.28);k.add(ne);let re=4.2,ie=.75,ae={mercury:1.2,venus:1.2,earth:1.2,mars:1.2,jupiter:1,saturn:1,uranus:1.2,neptune:1.2},oe=new Ji(re,64,64),se=bp(),I=new di(oe,se);d&&I.scale.setScalar(ie),k.add(I);let L=[],ce=vp();[{scale:2.5,color:16773839,opacity:.56},{scale:3.7,color:16757575,opacity:.32},{scale:5.1,color:16742973,opacity:.18}].forEach(({scale:e,color:t,opacity:n})=>{let r=new Ur(new kr({map:ce,color:t,transparent:!0,opacity:n,blending:2,depthWrite:!1})),i=re*e*(d?ie:1);r.scale.set(i,i,1),r.userData.baseScale=i,L.push(r),k.add(r)});let le=n.map(e=>id[e]).filter(Boolean);if(ee&&le.length===2){let e=Math.max(...le.map(e=>e.realDistanceAU));le=le.map(t=>({...t,distance:t.realDistanceAU/e*50}))}else le=le.map(e=>({...e}));let R=le.map(e=>{let t=Tp(e,E,c);if(d){let n=ae[e.key]??1;t.axialTilt.scale.setScalar(1*n)}return k.add(t.pivot),s&&k.add(yp(e.distance,e.color)),t}),ue=i&&_,de=y&&R.length>0||ue,fe=0,pe=!de&&!ue,me=0,he=!1,{maxSunScale:ge,maxPlanetScaleByKey:_e}=ap(le,{sunRadius:re,showMoon:c}),ve=e=>d?e:Math.min(e,ge),ye=(e,t)=>d?t:Math.min(t,_e[e.data.key]??t);function be(e){let t=Ct.clamp(e,0,1),n=Ct.lerp(ve(w),ve(b),t);I.scale.setScalar(n),L.forEach(e=>{let t=e.userData.baseScale;e.scale.set(t*n,t*n,1)}),R.forEach(e=>{let n=Ct.lerp(ye(e,T),ye(e,x),t);e.axialTilt.scale.setScalar(n)})}de&&be(0);let xe=R.map(e=>{let t=ip(e.data,c),n=d?1*(ae[e.data.key]??1):Math.max(ye(e,T),ye(e,x));return{distance:e.data.distance,extent:e.data.distance+t*n}}),Se=re*(d?ie:Math.max(ve(w),ve(b))),Ce=Math.max(...xe.map(e=>e.extent),Se,20),we=j<=640,Te=(()=>{let e=[...xe].sort((e,t)=>e.distance-t.distance),t=e.slice(0,Math.max(e.length-4,1));return Math.max(...t.map(e=>e.extent),Se,20)})(),Ee=d&&we?Te:Ce,De=D instanceof Date&&!Number.isNaN(D.getTime()),Oe=De?R.map(e=>Xf(e.data,D)):null,ke=R.map(e=>e.startAngle),z=Math.min(...R.map(e=>e.data.orbitalPeriodDays)),Ae=Math.max(...R.map(e=>e.data.orbitalPeriodDays)),je=De?ke.map((e,t)=>{let n=Oe[t];return(Dp(R[t].data)<0?((n-e)%gp+gp)%gp:((e-n)%gp+gp)%gp)+Ep(R[t].data.orbitalPeriodDays,z,Ae)*gp}):null,Me=0,B=!De,Ne=0,V=0,H=0,Pe=!De,Ie=!De,Le=!De,Re=[],ze=null,Be=null,Ve=0,He=new J;if(De&&R.length>=2){let e=[`mercury`,`venus`,`earth`,`mars`,`jupiter`,`saturn`,`uranus`,`neptune`],t=new Map(R.map(e=>[e.data.key,e])),n=e.map(e=>t.get(e)).filter(Boolean);if(n.length>=2){let e=[new J(0,0,0)];n.forEach(t=>{let n=R.indexOf(t),r=Oe?.[n]??t.startAngle;e.push(new J(t.data.distance*Math.cos(r),0,-t.data.distance*Math.sin(r)))});let t=[...e,e[0].clone()];ze=t,Be=[],Ve=0;for(let e=0;e<t.length-1;e++){let n=t[e].distanceTo(t[e+1]);Be.push(n),Ve+=n}let r=e=>{let n=new Cr().setFromPoints(t);n.setDrawRange(0,2);let r=new ji(n,new Ci({color:16777215,transparent:!0,opacity:e}));return r.visible=!1,r.userData.baseOpacity=e,r};Re=[r(.24),r(.85)],Re.forEach(e=>k.add(e))}}let Ue=ee?1.1:R.length<=2?1.14:1.08;function We(e,t,n){return e*t/Math.min(1,n)}let Ge=Ee,Ke=Ue,qe=null;if(P.isOrthographicCamera){let e=We(Ge,Ke,j/M);P.left=-e*j/M,P.right=e*j/M,P.top=e,P.bottom=-e,P.updateProjectionMatrix(),qe=e}let Je=lu(),U=new kn;U.add(Je);let W=new Wa(85,j/M,1,4e3);function Ye(e,t=Ce,n=Ue){if(P.isOrthographicCamera)return Math.max(t*n*3,200);let r=Ct.degToRad(P.fov);return t*n/(Math.tan(r/2)*Math.min(1,e))}function Xe(e,t,n=O){let r=Ye(e/t),i=-2*(r*Math.tan(Ct.degToRad(P.fov)/2))*n;P.up.set(0,0,-1),P.position.set(0,r,i+1e-4),P.lookAt(0,0,i)}let Ze=Ye(j/M);function Qe(e,t){let n=Ct.degToRad(t);return new J(0,e*Math.sin(n),e*Math.cos(n))}function $e(e){return e<.5?4*e*e*e:1-(-2*e+2)**3/2}function et(e){return-(Math.cos(Math.PI*e)-1)/2}function tt(e){return e*e*e*(e*(e*6-15)+10)}let nt=Qe(Ze,89.6),rt=Qe(Ze,24),G=We(Ee,Ue,j/M),it=We(Ce,1.35,j/M),at=new J(0,0,0),ot=l?`hold`:`done`,st=0,ct=null,lt=!1,ut=null,dt=null,ft=0;function pt(e){ut=new xu(P,F.domElement),ut.target.copy(e??new J(0,0,0)),ut.enableDamping=!0,ut.dampingFactor=.06,ut.enableZoom=!0,ut.zoomSpeed=.9,ut.minZoom=1,ut.maxZoom=3.5,ut.enablePan=!1,ut.enableDamping=!1,ut.autoRotate=!1,ut.update(),ut.enableDamping=!0,ft=2,ut.autoRotate=!l,ut.autoRotateSpeed=.35,dt||(dt=e=>{if(!ut||!ut.enableZoom||!P.isOrthographicCamera)return;let t;if(e.key===`+`||e.key===`=`)t=1.12;else if(e.key===`-`||e.key===`_`)t=1/1.12;else return;P.zoom=Ct.clamp(P.zoom*t,ut.minZoom,ut.maxZoom),P.updateProjectionMatrix(),e.preventDefault()},window.addEventListener(`keydown`,dt))}if(l)P.up.set(0,1,0),P.position.copy(nt),P.lookAt(at),P.isOrthographicCamera&&(P.left=-it*j/M,P.right=it*j/M,P.top=it,P.bottom=-it,P.updateProjectionMatrix(),qe=it);else if(u&&r){if(P.up.set(0,1,0),P.position.copy(rt),P.lookAt(at),P.isOrthographicCamera){let e=G;P.left=-e*j/M,P.right=e*j/M,P.top=e,P.bottom=-e,P.updateProjectionMatrix(),qe=e,Ge=Ee,Ke=Ue}P.lookAt(at),pt(at),ut.autoRotate=!1}else r?(P.position.set(0,Ze,Ze*.001),pt()):Xe(j,M);let mt=null,ht=null,gt=null,_t=null,vt=0,yt=0,bt=[[0,1]],xt=new J,St=new J;if(i&&R.length>=2){bt=o?R.map((e,t)=>[t,(t+1)%R.length]):[[0,1]];let e=Math.ceil(p*hp/m);vt=Math.min(e*bt.length,4e4),ht=new Float32Array(vt*2*3);let t=new Iu;t.setPositions(ht),t.instanceCount=0,gt=new Float32Array(vt*2),_t=new _o(gt,2,1),t.setAttribute(`instanceDistanceStart`,new Er(_t,1,0)),t.setAttribute(`instanceDistanceEnd`,new Er(_t,1,1));let n=new Lu({color:16777215,transparent:!0,opacity:h,linewidth:Qf,depthWrite:!1,dashed:!0,dashScale:1,dashSize:pp.solid.dashSize,gapSize:pp.solid.gapSize});n.resolution.set(j,M),mt=new nd(t,n),mt.frustumCulled=!1,k.add(mt)}let K=new no;K.connect(document);let q=0,wt=0,Tt=0,Et=i?p*hp/f:6,Y=v,Dt=_,Ot=!1,kt=null,At=null,X=`solid`;function jt(e,t){let n=(g?g[e.data.key]:void 0)??(a?365.256/e.data.orbitalPeriodDays:e.data.traceSpeed??365.256/e.data.orbitalPeriodDays);return e.startAngle+Dp(e.data)*(t/hp)*n*gp}function Mt(e,t,n){let r=jt(e,t);return n.set(e.data.distance*Math.cos(r),0,-e.data.distance*Math.sin(r))}function Nt(){if(!mt||yt>=vt)return;let e=!1,t=bt.length;for(;q-Tt>=m&&yt+t<=vt;){Tt+=m;for(let e=0;e<t;e++){let t=bt[e];Mt(R[t[0]],Tt,xt),Mt(R[t[1]],Tt,St);let n=yt*6;ht[n]=xt.x,ht[n+1]=xt.y,ht[n+2]=xt.z,ht[n+3]=St.x,ht[n+4]=St.y,ht[n+5]=St.z;let r=yt*2;gt[r]=0,gt[r+1]=xt.distanceTo(St),yt++}e=!0}e&&(mt.geometry.attributes.instanceStart.data.needsUpdate=!0,mt.geometry.instanceCount=yt,_t.needsUpdate=!0)}function Pt(){F.clear(),W.quaternion.copy(P.quaternion),F.render(U,W),F.clearDepth(),F.render(k,P)}function Ft(e){At=requestAnimationFrame(Ft),K.update(e);let t=Math.min(K.getDelta(),.05);if(Dt){Pt();return}if(ue&&!he&&!Dt&&(he=!0,fe=0),!pe){fe+=t;let e=0;if(ue&&he){let t=Math.max(0,fe-.3);e=Math.min(t/Math.max(.01,S),1)}else y&&!ue&&(e=Math.min(fe/Math.max(.01,S),1));be(tt(e)),e>=1&&(pe=!0)}de&&pe&&(me=Math.min(me+t,Math.max(.01,C)));let n=de?pe?Ct.clamp(me/Math.max(.01,C),0,1):0:1,a=De?De&&B&&!Pe?-1:0:1;if(I.rotation.y+=t*.03*a,se.uniforms.time.value+=t*a,Je.children.forEach(e=>{De||(e.rotation.y+=t*e.userData.spin),e.material.uniforms?.uTime&&(e.material.uniforms.uTime.value+=t)}),Ot||(q+=t*Et*Y*n),Ot||(wt+=t*n),De&&!B)Me+=t,R.forEach((e,t)=>{let n=ke[t];e.pivot.rotation.y=n,e.tiltAnchor.rotation.y=-n}),Me>=1&&(B=!0);else if(De&&!Pe){Ne+=t;let e=Math.min(Ne/7.2,1),n=et(e);R.forEach((e,t)=>{let r=Dp(e.data)<0?ke[t]+je[t]*n:ke[t]-je[t]*n;e.pivot.rotation.y=r,e.tiltAnchor.rotation.y=-r}),e>=1&&(R.forEach((e,t)=>{let n=Oe[t];e.pivot.rotation.y=n,e.tiltAnchor.rotation.y=-n}),Pe=!0)}else De&&!Ie?(R.forEach((e,t)=>{let n=Oe[t];e.pivot.rotation.y=n,e.tiltAnchor.rotation.y=-n}),V+=t,V>=.7&&(Ie=!0)):De?R.forEach((e,t)=>{let n=Oe[t];e.pivot.rotation.y=n,e.tiltAnchor.rotation.y=-n}):R.forEach(e=>{i?e.pivot.rotation.y=jt(e,q):e.pivot.rotation.y=e.startAngle+wt*e.browseSpeed*Dp(e.data),e.tiltAnchor.rotation.y=-e.pivot.rotation.y});if(R.forEach(e=>{e.mesh.rotation.y+=t*60*e.data.rotationSpeed*(e.data.spinDirection??1)*n*a,e.clouds&&(e.clouds.rotation.y+=t*60*e.data.rotationSpeed*1.4*(e.data.spinDirection??1)*n*a),e.moonPivot&&(e.moonPivot.rotation.y+=t*1.4*a)}),k.updateMatrixWorld(!0),i&&(!ue||pe)&&Nt(),De&&Pe&&Ie&&Re.length>0&&!Le){H+=t;let e=Math.min(H/2.8,1),n=tt(e)*Ve,r=0;for(;r<Be.length-1&&n>Be[r];)n-=Be[r],r++;let i=Be[r]||1,a=e>=1?1:Math.min(n/i,1);He.lerpVectors(ze[r],ze[r+1],a),Re.forEach(e=>{e.visible=!0;let t=e.geometry.attributes.position;for(let e=0;e<=r;e++)t.setXYZ(e,ze[e].x,ze[e].y,ze[e].z);t.setXYZ(r+1,He.x,He.y,He.z),t.needsUpdate=!0,e.geometry.setDrawRange(0,r+2)}),e>=1&&(Le=!0)}if(i&&!Ot&&q>=p*hp&&(Ot=!0,kt&&kt()),De&&Le&&!Ot&&(Ot=!0,kt&&kt()),ot!==`done`){if(st+=t,ot===`hold`)st>=.8&&(ot=`travel`,st=0);else if(ot===`travel`){let e=Math.min(st/2.1,1),t=$e(e);P.position.lerpVectors(nt,rt,t),P.lookAt(at),e>=1&&(ot=`zoom`,st=0)}else if(ot===`zoom`){let e=Math.min(st/2.2,1),t=tt(e);if(P.isOrthographicCamera){let e=it*(G/it)**+t;P.left=-e*j/M,P.right=e*j/M,P.top=e,P.bottom=-e,P.updateProjectionMatrix(),qe=e}e>=1&&(ot=`done`,Ge=Ee,Ke=Ue,P.lookAt(at),r&&pt(at),ct&&(lt=!0))}}ut&&(ft>0?--ft:ut.update()),Pt(),lt&&(lt=!1,ct?.())}function It(){let e=A?.clientWidth||window.innerWidth,t=A?.clientHeight||window.innerHeight;if(P.isOrthographicCamera){let n=qe??We(Ge,Ke,e/t);P.left=-n*e/t,P.right=n*e/t,P.top=n,P.bottom=-n}else P.aspect=e/t,ut||Xe(e,t);P.updateProjectionMatrix(),W.aspect=e/t,W.updateProjectionMatrix(),F.setSize(e,t,!1),mt&&mt.material.resolution.set(e,t)}let Lt=new ResizeObserver(It);return A&&Lt.observe(A),window.addEventListener(`resize`,It),{start(){At??Ft()},setPaused(e){Dt=e},setLineStyle(e){if(X=pp[e]?e:`solid`,!mt)return;let t=pp[X];mt.material.dashSize=t.dashSize,mt.material.gapSize=t.gapSize,mt.material.linewidth=Qf*(t.widthScale??1)},setSpeedMultiplier(e){Y=Math.max(.1,e)},reset(){q=0,Tt=0,yt=0,Ot=!1,fe=0,pe=!de&&!ue,me=0,he=!1,Me=0,B=!De,Ne=0,V=0,H=0,Pe=!De,Ie=!De,Le=!De,de&&be(0),mt&&(mt.geometry.instanceCount=0),R.forEach(e=>{e.pivot.rotation.y=e.startAngle,e.tiltAnchor.rotation.y=-e.startAngle}),Re.forEach(e=>{e.visible=!1,e.geometry.setDrawRange(0,2),e.material.opacity=e.userData.baseOpacity}),k.updateMatrixWorld(!0),Pt()},getProgress(){return i?Math.min(q/(p*hp),1):0},onComplete(e){kt=e},onIntroComplete(e){ct=e,ot===`done`&&e()},captureDataURL(){let e=P.position.clone(),t=P.quaternion.clone(),n=!ut&&P.isPerspectiveCamera&&O!==0;n&&(Xe(j,M,0),P.updateMatrixWorld(!0));let r=Math.max(F.getPixelRatio(),2);F.setPixelRatio(r),F.setSize(j,M,!1);let i=I.visible;De||(I.visible=!1,L.forEach(e=>{e.visible=!1}),R.forEach(e=>{e.pivot.visible=!1}));let a=mt?mt.visible:!1;mt&&(mt.visible=!1),Pt(),mt&&(mt.visible=a);let o=F.domElement.width,s=F.domElement.height,c=document.createElement(`canvas`);c.width=o,c.height=s;let l=c.getContext(`2d`);if(l.drawImage(F.domElement,0,0),mt&&yt>0){l.strokeStyle=`rgba(255,255,255,${X===`dots`?1:h})`,l.lineJoin=`round`;let e=mp[X],t=pp[X];l.lineWidth=Qf*r*(e?.widthScale??1),l.lineCap=e?.cap??`round`;let n=new J;for(let i=0;i<yt;i++){let a=i*6;n.set(ht[a],ht[a+1],ht[a+2]).project(P);let c=(n.x*.5+.5)*o,u=(1-(n.y*.5+.5))*s;n.set(ht[a+3],ht[a+4],ht[a+5]).project(P);let d=(n.x*.5+.5)*o,f=(1-(n.y*.5+.5))*s;if(e&&X!==`solid`){let n=gt[i*2+1]||1,a=(Math.hypot(d-c,f-u)||1)/n,o=e.fixedDashPx==null?t.dashSize*a:e.fixedDashPx*r;l.setLineDash([o,t.gapSize*a])}else l.setLineDash([]);l.beginPath(),l.moveTo(c,u),l.lineTo(d,f),l.stroke()}}let u=c.toDataURL(`image/png`);return I.visible=i,L.forEach(e=>{e.visible=!0}),R.forEach(e=>{e.pivot.visible=!0}),n&&(P.position.copy(e),P.quaternion.copy(t),P.updateMatrixWorld(!0)),F.setPixelRatio(Math.min(window.devicePixelRatio||1,2)),F.setSize(j,M,!1),Pt(),u},destroy(){At!=null&&cancelAnimationFrame(At),K.dispose(),window.removeEventListener(`resize`,It),dt&&window.removeEventListener(`keydown`,dt),Lt.disconnect(),ut&&ut.dispose(),F.dispose(),k.traverse(e=>{e.geometry&&e.geometry.dispose(),e.material&&(Array.isArray(e.material)?e.material:[e.material]).forEach(e=>e.dispose())})}}}function kp(e){let t=new xn,{tiltGroup:n,mesh:r,material:i,ring:a}=fp(e,{radius:1,tiltAxis:`x`});n.rotation.set(0,0,0);let o=new xn;return o.add(n),t.add(o),i.transparent=!0,a&&(a.material.transparent=!0,a.rotation.x=-Math.PI/2,n.rotation.x=Ct.degToRad(15),n.rotation.y=Ct.degToRad(30),o.rotation.z=Ct.degToRad(30),a.userData.presentationScale=.94),{group:t,mesh:r,material:i,ring:a,spinSpeed:.02*(e.spinDirection??1)*15}}function Ap(e,t){let n=Kl(e,{alpha:!0,antialias:!0});n.setClearColor(0,0),n.outputColorSpace=Fe;let r=new kn,i=new qa(-1,1,1,-1,-2e3,2e3);i.position.z=400,r.add(new Xa(16777215,.58));let a=new Ya(16773855,2.1);a.position.set(-140,90,260),r.add(a);let o=new Map;t.forEach(e=>{let t=kp(e);r.add(t.group),o.set(e.key,t)});let s=null,c=new no;c.connect(document);function l(e){o.forEach((t,n)=>{e[n]!=null&&(t.group.position.x=e[n])})}function u(e,t,r,a){n.setPixelRatio(Math.min(a||1,2)),n.setSize(t,r,!1),i.left=-t/2,i.right=t/2,i.top=r/2,i.bottom=-r/2,i.position.x=e+t/2,i.updateProjectionMatrix()}function d(e,{radiusPx:t,scale:n,opacity:r,dim:i,disabled:a}){let s=o.get(e);if(!s)return;let c=t*n;s.mesh.scale.setScalar(c),s.material.opacity=a?Math.min(r,.35):r,s.material.color.setScalar(a?.4:i),s.ring&&(s.ring.scale.setScalar(c*(s.ring.userData.presentationScale??1)),s.ring.material.opacity=a?Math.min(r,.35):r,s.ring.material.color.setScalar(a?.4:i))}function f(e){s=requestAnimationFrame(f),c.update(e);let t=Math.min(c.getDelta(),.05);o.forEach(e=>{e.mesh.rotation.y+=t*e.spinSpeed}),n.render(r,i)}return{setLayout:l,setViewport:u,setPlanetState:d,start(){s??f()},destroy(){s!=null&&cancelAnimationFrame(s),c.dispose(),r.traverse(e=>{e.geometry&&e.geometry.dispose(),e.material&&(Array.isArray(e.material)?e.material:[e.material]).forEach(e=>e.dispose())}),n.dispose()}}}export{Xf as a,uu as c,tp as i,Op as n,rd as o,up as r,id as s,Ap as t};